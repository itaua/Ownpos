...
public class NotificationReceiver extends BroadcastReceiver {
    public static final String YES_NOTIFICATION_BUTTON = "itauamachado.ownpos.service.YES_NOTIFICATION_BUTTON";
    public static final String MAYBE_NOTIFICATION_BUTTON = "itauamachado.ownpos.service.MAYBE_NOTIFICATION_BUTTON";
    public static final String NO_NOTIFICATION_BUTTON = "itauamachado.ownpos.service.NO_NOTIFICATION_BUTTON";
